<template>
    <div class="page-table" :class="className">
        ...
        >
            ...
            <!-- 序号 -->
            <el-table-column v-if="tabIndex" align="center" type="index" width="55"></el-table-column>
            ...
            <!-- 操作列 -->
            <el-table-column v-if="handle" :column-key="'handle'" :fixed="handle.fixed" :align="handle.align" :label="handle.label" :width="handle.width">
                <template #default="scope">
